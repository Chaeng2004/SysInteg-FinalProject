      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/20">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full py-4 bg-white text-black font-semibold rounded-full hover:bg-red-500 hover:text-white transition-all mt-6"
          >
        ...
        <button className="w-full py-4 bg-white/70 text-black font-medium rounded-full hover:bg-white transition-all flex items-center justify-center gap-3">
